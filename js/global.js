window.root ='http://chenchen.wms.cn/index.php/'; //'http://api.yushan.com/';/*http://api.yushan.com/*/
...
if(style1['codeid1']){
    ...
    cscope.com_list.params = {"codeid":fac.getcd(cscope,'c5'),"c_alias":"QS_diary","orderstrid":3};
...
index:{ 
    init:function(sco){
        ...
        sco.com_list4.params = {"codeid":fac.getcd(sco,'c5'),"c_alias":"QS_diary","orderstrid":3};
...
diary:{ 
    init:function(sco){
        ...
        sco.com_list_page.done = function(re,sco){
            ...
            sco.com_list.params = {"codeid":fac.getcd(sco,'c5'),"c_alias":"QS_diary","orderstrid":3,"diarytype":sco.com_list_page.params.diarytype};
            sco.com_list.time = fac.time();
            sco.com_list.done = function(re,sco){
...
album:{ 
    init:function(sco){
        ...
        sco.com_list.params = {"codeid":fac.getcd(sco,'c9'),"orderstrid":3};
    ...
    init:function(sco){
        ...
        $(document).ready(function () {
            ...
            $(document).on('click',".diarybutton",function(){
              ...
              scheduleobj = {title:$('#blog_search_text').val(),end:$('#blog_search_text2').val()};
